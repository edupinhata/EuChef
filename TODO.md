...
- [x] **Criar o frontend completo de receitas por TDD.**
...
- [x] Adicionar espaço para fazer um embedding de um vídeo do YouTube sobre a receita a ser feita. O vídeo deve ser mais abaixo, de modo que o mais importante: ingredientes e modo de preparo, fiquem mais evidentes e rápidos de pesquisar.
- [x] Adicionar lugar para considerar o tempo de preparo estimado da receita.
- [x] Adicionar informações de qual usuário criou a receita. A ideia é futuramente poder pegar receitas de outros usuários.
- [x] Apenas o usuário que criou uma receita pode editar aquela receita.
- [x] Administradores (role ADMIN) devem ter o poder de editar receitas de outros usuários.
